...
<body>
        ...
        <header>
            ...
            <div class="container">
                <nav>
                    ...
                    <div class="menu-icon">                    <!--só aparece na metade da tela?-->
    ...
    <footer>
            ...
            <!--ul 2-->
                <ul>
                    <h3>link</h3>
                    <li><a href="index.jsl">Inicial</a></li>
                    <li><a href="produtos.jsl">Produtos</a></li>
                    <li><a href="orcamento.jsl">Orçamento</a></li>
                    <li><a href="sobre.jsl">Sobre</a></li>
                    <li><a href="contato.jsl">Contato</a></li>
                </ul>
            <!--Fim ul 2-->
            <!--ul 3-->
                <ul>
                    <h3>Suporte</h3>
                    <li><a href="orcamento.jsl">FAQ</a></li>
                    <li><a href="sobre.jsl">Como Funciona</a></li>
                    <li><a href="index.jsl">Caracteristicas</a></li>
                    <li><a href="contato.jsl">Contato</a></li>
                    <li><a href="contato.jsl">Comunicado</a></li>
                </ul>
            <!--Fim ul 3-->
            <!--ul 4-->
                <ul>
